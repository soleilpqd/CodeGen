...
extension XCProject {
    ...
    private func buildStrings(target: XCProjTarget, store: inout [String: [String : [String: [String]]]], languages: inout [String], errors: inout [String: Error]) {
                    ...
                    for item in files {
                        if let f = item as? XCFileReference, f.lastKnownFileTypeEnum == .strings, let name = item.path, let path = f.getFullPath() {
                            do {
                                ...
                                var langStrings = [String: [String: [String]]]()
    ...
    /// return: [FileName: [Key: [Language: [Values]]]]
    func buildStrings(languages: inout [String], errors: inout [String: Error]) -> [String: [String : [String: [String]]]] {
