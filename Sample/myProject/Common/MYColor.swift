...
extension UIColor {
    ...
    static var myArapawaLight: UIColor {
        return makeColor(name: "Arapawa Light", colorSpace: "srgb", red: 0.039, green: 0.039, blue: 0.4, white: 0.0, alpha: 1.0)
    }

    /// Athens Gray
    /// universal: srgb #EEEEF4 100% "White Lilac"
    static var myAthensGray: UIColor {
        return makeColor(name: "Athens Gray", colorSpace: "srgb", red: 0.937, green: 0.937, blue: 0.957, white: 0.0, alpha: 1.0)
    }

    /// Azure Radiance
    /// universal: srgb #007BF9 100% "Azure Radiance"
    static var myAzureRadiance: UIColor {
        return makeColor(name: "Azure Radiance", colorSpace: "srgb", red: 0.0, green: 0.486, blue: 0.98, white: 0.0, alpha: 1.0)
    }

    /// BlackAlpha40
    /// universal: srgb #000000 40% "Black"
    static var myBlackAlpha40: UIColor {
        return makeColor(name: "BlackAlpha40", colorSpace: "srgb", red: 0.0, green: 0.0, blue: 0.0, white: 0.0, alpha: 0.404)
    }

    /// Boulder
    /// universal: srgb #777777 100% "Boulder"
    static var myBoulder: UIColor {
        return makeColor(name: "Boulder", colorSpace: "srgb", red: 0.467, green: 0.467, blue: 0.467, white: 0.0, alpha: 1.0)
    }
    ...
    static var myGallery: UIColor {
        return makeColor(name: "Gallery", colorSpace: "srgb", red: 0.933, green: 0.933, blue: 0.933, white: 0.0, alpha: 1.0)
    }

    /// Jade
    /// universal: srgb #00BE5F 100% "Jade"
    static var myJade: UIColor {
        return makeColor(name: "Jade", colorSpace: "srgb", red: 0.0, green: 0.749, blue: 0.376, white: 0.0, alpha: 1.0)
    }

    /// Moody Blue
    /// universal: srgb #7979CC 100% "Moody Blue"
    static var myMoodyBlue: UIColor {
        return makeColor(name: "Moody Blue", colorSpace: "srgb", red: 0.478, green: 0.478, blue: 0.8, white: 0.0, alpha: 1.0)
    }

    /// Outer Space
    /// universal: srgb #253138 100% "Ebony Clay"
    static var myOuterSpace: UIColor {
        return makeColor(name: "Outer Space", colorSpace: "srgb", red: 0.149, green: 0.196, blue: 0.22, white: 0.0, alpha: 1.0)
    }

    /// Pizazz
    /// universal: srgb #FF9100 100% "Pizazz"
    static var myPizazz: UIColor {
        return makeColor(name: "Pizazz", colorSpace: "srgb", red: 1.0, green: 0.569, blue: 0.0, white: 0.0, alpha: 1.0)
    }

    /// Porcelain
    /// universal: srgb #EBEEF0 100% "Porcelain"
    static var myPorcelain: UIColor {
        return makeColor(name: "Porcelain", colorSpace: "srgb", red: 0.925, green: 0.937, blue: 0.945, white: 0.0, alpha: 1.0)
    }

    /// Regent Gray
    /// universal: srgb #78909C 100% "Gumbo"
    static var myRegentGray: UIColor {
        return makeColor(name: "Regent Gray", colorSpace: "srgb", red: 0.471, green: 0.565, blue: 0.612, white: 0.0, alpha: 1.0)
    }

    /// Silver
    /// universal: srgb #CCCCCC 100% "Silver"
    static var mySilver: UIColor {
        return makeColor(name: "Silver", colorSpace: "srgb", red: 0.8, green: 0.8, blue: 0.8, white: 0.0, alpha: 1.0)
    }

    /// Tower Gray
    /// universal: srgb #AFBDC5 100% "Tower Gray"
    static var myTowerGray: UIColor {
        return makeColor(name: "Tower Gray", colorSpace: "srgb", red: 0.69, green: 0.745, blue: 0.773, white: 0.0, alpha: 1.0)
    }
